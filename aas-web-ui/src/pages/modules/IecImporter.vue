                ...
                <v-expansion-panels class="mb-3">
                    <v-expansion-panel>
                        ...
                        <v-expansion-panel-text>
                            <v-alert density="compact" class="mb-3" type="success" variant="tonal">
                                <strong>No account required:</strong> the IEC CDD lets you browse and export Excel files
                                directly &mdash; there is no login, sign-up or paywall for the steps below.
                            </v-alert>
                            <ol class="tutorial-list">
                                <li class="mb-2">
                                    Open the IEC Common Data Dictionary at
                                    <a href="https://cdd.iec.ch" rel="noopener" target="_blank">cdd.iec.ch</a>. Use the
                                    tree navigation on the left or the search bar at the top right to locate the desired
                                    <strong>class</strong> or <strong>property</strong>, then click it to open the
                                    detail view. You should see the metadata table (<code>code</code>,
                                    <code>preferred name</code>, <code>definition</code>, <code>primary unit</code>,
                                    <code>data type</code>, &hellip;) and four orange action buttons above it.
                                </li>
                                <li class="mb-2">
                                    Click the orange <strong>Export</strong> button in the toolbar above the metadata
                                    table.
                                ...
                                <li class="mb-2">
                                    ...
                                    <ul class="mt-1">
                                        <li><strong>Attributes</strong> &mdash; the metadata of the selected class itself.</li>
                                        <li><strong>Properties</strong> &mdash; all properties of the selected class as rows.</li>
                                        <li><strong>All</strong> &mdash; attributes and properties combined.</li>
                                    </ul>
                                ...
                                <li class="mb-2">
                                    A download page opens with the green Excel icon. Click <strong>Download</strong> to
                                    save the <code>.xlsx</code> file straight to your downloads folder &mdash; no login
                                    prompt appears.
                                    <div class="tutorial-figure my-2">
                                        <img
                                            class="tutorial-img"
                                ...
                                <li>
                                    Come back here, click <em>Upload files</em> below and select the downloaded Excel
                                    file (or several files at once) to import.
                                </li>
                            </ol>
                            <v-alert density="compact" class="mt-3" type="info" variant="tonal">
                                <strong>Tip:</strong> The importer auto-detects the IEC-CDD header row (e.g.
                                <code>#property_name</code>, <code>code</code>, <code>preferredname</code>,
                                <code>primaryunit</code>, <code>data_type</code>). Custom Excel layouts that do not
                                contain these columns will not be recognised as IEC-CDD properties.
                            </v-alert>
                        </v-expansion-panel-text>
                    </v-expansion-panel>
                </v-expansion-panels>
